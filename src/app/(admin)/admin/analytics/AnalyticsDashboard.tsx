...
export default function AnalyticsDashboard({ initialStats }: { initialStats: ApiCallStats }) {
  ...
  const xAxisInterval = range === "day" ? 2 : range === "month" ? 3 : 0;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass-card rounded-2xl p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">{RANGE_LABELS[range]} — successful vs. failed calls</p>
        {stats.totalCalls === 0 ? (
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        <div className="p-6 border-b border-border flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">{RANGE_LABELS[range]} — most recent first, up to 50</p>
          </div>
